...
ssize_t is_empty_show(struct kobject *kobj, struct kobj_attribute *attr,
		      char *buf)
{
...
ssize_t clear_store(struct kobject *kobj, struct kobj_attribute *attr,
		    const char *buf, size_t count)
{
...
static struct attribute *attrs[] = {
	&push.attr,  &peek.attr, &pop.attr, &is_empty.attr,
	&clear.attr, &size.attr, NULL,
};
